...
dtype = torch.float32
out_dir = "/raid/cvg_data/lurenjie/P2P/prompt_travel/stylize/warp_test/output_classify_body_512"
...
img_path = "/raid/cvg_data/lurenjie/P2P/prompt_travel/stylize/warp_test/0_openpose_384.png"
...
p2p.p2p.show_cross_attention(prompts, store_controller, res=16, from_where=["up", "down"], select=1, save_dir=out_dir)
...
control_image = Image.open("/raid/cvg_data/lurenjie/P2P/prompt_travel/stylize/warp_test/50_openpose_384.png")
...
p2p.p2p.show_cross_attention(prompts, replace_controller, res=16, from_where=["up", "down"], select=1, save_dir=out_dir)
...
images[0].save(os.path.join(out_dir, "50_warp_step25.png"))
show_img.append(images[0])
...
images, all_latents = pipe(
    ...
    ref_fg_latents=fg_latents,
    use_warp_blend=True,
    warp_belnd_steps=[0, sample_steps//2 + 5],
)
images[0].save(os.path.join(out_dir, "50_warp_step30.png"))
show_img.append(images[0])
...
images, all_latents = pipe(
    ...
    ref_fg_latents=fg_latents,
    use_warp_blend=True,
    warp_belnd_steps=[0, sample_steps//2 + 10],
)
images[0].save(os.path.join(out_dir, "50_warp_step35.png"))
show_img.append(images[0])
...
images, all_latents = pipe(
    ...
    ref_fg_latents=fg_latents,
    use_warp_blend=True,
    warp_belnd_steps=[0, sample_steps//2 + 15],
)
images[0].save(os.path.join(out_dir, "50_warp_step40.png"))
show_img.append(images[0])
...
images, all_latents = pipe(
    ...
    ref_fg_latents=fg_latents,
    use_warp_blend=True,
    warp_belnd_steps=[0, sample_steps//2 + 20],
)
images[0].save(os.path.join(out_dir, "50_warp_step45.png"))
show_img.append(images[0])
...
images[0].save(os.path.join(out_dir, "50_warp_step50.png"))
show_img.append(images[0])
