...
def create_controlnet_model(type_str):
    if type_str == "controlnet_tile":
        ...
        return ControlNetModel.from_pretrained('/raid/cvg_data/ECCV2024/code/magic-animate/pretrained_models/MagicAnimate/densepose_controlnet')
    ...
    elif type_str == "controlnet_densepose_ma":
        # return ControlNetModel.from_pretrained('lllyasviel/control_v11p_sd15_canny')
        return ControlNetModel.from_pretrained('/raid/cvg_data/ECCV2024/code/magic-animate/pretrained_models/MagicAnimate/densepose_controlnet')
    elif type_str == "controlnet_densepose":
        # return ControlNetModel.from_pretrained('lllyasviel/control_v11p_sd15_canny')
        return ControlNetModel.from_pretrained('/home/jianshu/code/sd/controlnet/densepose/checkpoint-17000/controlnet')
    else:
                ...
                for img_path in tqdm(imgs, desc=f"Preprocessing images (ip_adapter)"):
                    ...
                    if frame_no < duration:
                        if resized_to_square:
                            ...
                            ip_adapter_map["images"][frame_no] = get_resized_image(img_path, 512, 904)
                        else:
                            # ip_adapter_map["images"][frame_no] = get_resized_image2(img_path, 256)
                            ip_adapter_map["images"][frame_no] = get_resized_image2(img_path, 512)
                        processed = True
