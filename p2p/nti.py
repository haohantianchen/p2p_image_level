...
from . import p2p, ptp_utils, seq_aligner
...
class NullInversion:
    ...
    def __init__(self, model, num_ddim_steps=50, device=torch.device('cuda:0')):
...
def run_and_display(pipe, prompts, controller, latent=None, run_baseline=False, generator=None, uncond_embeddings=None, verbose=True, num_ddim_steps=50):
    if run_baseline:
        print("w.o. prompt-to-prompt")
        images, latent = run_and_display(prompts, p2p.EmptyControl(), latent=latent, run_baseline=False, generator=generator)
...
# image_path = "/home/jianshu/code/prompt_travel/stylize/course3_1227/seg/0/00_controlnet_image/controlnet_openpose/00000000.png"
# prompt = "a cat sitting next to a mirror"
# (image_gt, image_enc), x_t, uncond_embeddings = null_inversion.invert(image_path, prompt, offsets=(0,0,200,0), verbose=True)
# torch.save(x_t, "xt.pt")
# torch.save(uncond_embeddings, "unc.pt")
